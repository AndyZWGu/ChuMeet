...
//		ActStarVO actStar = (ActStarVO) session.getAttribute("actStarVO");
		...
		FriendsVO memFriendsVO = (FriendsVO) session.getAttribute("memFriendsVO");
		req.setAttribute("memVO", memVO);
		req.setAttribute("memNFVO", memNFVO);
		req.setAttribute("achVO", achVO);
		req.setAttribute("memAchVO", memAchVO);
		req.setAttribute("memVO", memVO);
		//拿照片
		...
		//
		String url = "/front-end/member/memHome.jsp?id="+memVO.getMemID(); 
