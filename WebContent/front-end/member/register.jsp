                        ...
                        <div class="panel-body">
                            <form onsubmit="return check()" method="post" action="<%=request.getContextPath()%>/front-end/member/memberRegister.do" enctype="multipart/form-data" data-toggle="validator" role="form">
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input type="text" class="form-control input-sm" id="LocBorn" name="memLocBorn" placeholder="出生地" required>
                                </div>
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input type="text" class="form-control input-sm" id="LocLive" name="memLocLive" placeholder="居住地" required>
                                </div>
                                <div class="form-group  col-md-6 col-sm-6">
                                ...
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <textarea class="form-control input-sm" id="memInt" name="memInt" rows="8" required></textarea>
                                </div>
