						...
						<table class="table  table-hover">
							...
							<tbody>
								<tr>
									...
									<td>
												<div class="radio">
												  <label><input type="radio" name="optradio" value="0" checked><i class="fa fa-check-square" aria-hidden="true"></i></label>
												</div>
												<div class="radio">
												  <label><input type="radio" name="optradio" value="4"><i class="fa fa-ban" aria-hidden="true"></i></label>
												</div>
												<div class="radio">
												  <label><input type="radio" name="optradio" value="5"><i class="fa fa-question-circle" aria-hidden="true"></i></label>
												</div>
									</td>
									<td>
											<input type="checkbox" id="switch" /><label class="cclabel" for="switch">推</label>
									</td>
									<td>actAddr</td>
