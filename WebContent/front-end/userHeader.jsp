...
<c:if test="${memVO!=null}" var="loginStatus" scope="session" > 
        ...
        <div class="col-md-6 col-sm-6 additional-nav">
          <ul class="list-unstyled list-inline pull-right">
            <li><span>哈囉，${memVO.memName}</span> <a href="<%=request.getContextPath()%>/front-end/member/memHome.jsp"><i class="fa fa-cog" aria-hidden="true"></i>會員首頁</a></li>
            ...
            <li><a href="<%=request.getContextPath()%>/front-end/member/memEmail.jsp"><i class="fa fa-envelope-o" aria-hidden="true"></i>消息</a></li>
          </ul>
        </div>
        <!-- END TOP BAR MENU -->
</c:if>
...
=======
            <li><a href="<%=request.getContextPath()%>/HTML/act/actStart.html"><span class="topst"> 開始揪團吧！ </span></a></li>
          </ul>
